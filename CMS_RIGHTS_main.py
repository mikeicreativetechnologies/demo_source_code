...
class CMSRights(http.Controller):
    ...
    def website_template_pages_load(self, **kw):
        ...
        #MMs can preview all saved page templates
            ...
            page_templates = request.env['ir.ui.view'].search([('is_webpage_template', '=', True), ('user_id', '=', request.env.user.id)])
    ...
    def website_template_pages_new(self, **kw):
        ...
        if values['template_id']:
            ...
            page_template = request.env['ir.ui.view'].search([('name', '=', 'default_page')])
